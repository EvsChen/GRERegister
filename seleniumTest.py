...
# WARNING: Necessary to install chrome driver
...
captcha_input = WebDriverWait(driver, 20, 0.5).until(
...
webdriver.ActionChains(driver).move_to_element(captcha_input).click(captcha_input).perform()
